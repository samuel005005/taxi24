...
export class DriverService {
    ...
    constructor(
        ...
        this.currentLocationDriverUseCase = new CurrentLocationDriverUseCase(this.driverRepository);
    }
    ...
    async update(term: string, updateDriverDto: UpdateDriverDto) {
        ...
        const driver = await this.updateDriverUseCase.handler(term, DriverMapper.DtoToDomain(updateDriverDto));
    ...
    async currentLocation(idDriver: string, currentLocationDriverDto: CurrentLocationDriverDto) {
        return this.currentLocationDriverUseCase.handler(idDriver,currentLocationDriverDto.latitud,currentLocationDriverDto.longitud);
    }
}